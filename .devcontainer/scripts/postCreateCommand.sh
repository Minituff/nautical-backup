...
echo "alias nbt=\"cd /workspaces/nautical-backup && docker build -f Dockerfile.test -t nautical-test --progress=plain --no-cache --build-arg='NAUTICAL_VERSION=testing' .\"" >> ~/.zshrc
