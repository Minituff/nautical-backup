...
<small>🔄 This is the same action as the [Mirror Source Directory Name to Desitination](./arguments.md#mirror-source-directory-name-to-desitination) variable, but applied only to this container.</small>
